class GameScene1 extends Phaser.Scene {
    ...
    init() {
        console.log("===GameScene1 started");
    ...
    createAudio() {
        ...
        // Adding Sounds
        this.music = this.sound.add('lvl1Music');
        this.music.play();
    ...
    createBackground() {
        // create bg sprite
        this.lvl1Background = this.add.tileSprite(0, 0, game.config.width, game.config.height, 'lvl1Background');
